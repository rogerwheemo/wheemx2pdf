...
def generate_compact_pdf(values: dict, peak_torque_nm: float, temp_range: tuple,
    ...
    mass_val, mass_unit = format_mass(values['machine_mass_kg'])
    config_data = [
        ...
        ["Machine Mass (active components only)", mass_val, mass_unit],
